      ...
      <div className="container mx-auto py-3 md:py-4 px-4 md:px-6">
        <div className="flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2 z-10">
            ...
            <h1 className="text-xl font-bold text-gray-900">OrbitFiles</h1>
          </Link>
          ...
          <div className="hidden md:flex gap-4 items-center">
            ...
            <SignedIn>
              <div className="flex items-center gap-4">
                {!isOnDashboard && (
                  <Link href="/dashboard">
                    <Button variant="flat" color="primary">Dashboard</Button>
                  </Link>
                )}
                <Dropdown>
                  <DropdownTrigger>
            ...
            <SignedIn>
              <div className="flex flex-col gap-6">
                <div className="flex items-center gap-3 py-4 border-b border-gray-200">
                  ...
                  />
                  <div>
                    <p className="font-medium text-gray-900">{userDetails.displayName}</p>
                ...
                <div className="flex flex-col gap-4">
                  {!isOnDashboard && (
                    <Link
                      href="/dashboard"
                      className="py-2 px-3 hover:bg-gray-100 rounded-md transition-colors text-gray-900"
                      onClick={() => setIsMobileMenuOpen(false)}
                    >
                      Dashboard
                    </Link>
                  ...
                  <button
                    className="py-2 px-3 text-left text-danger hover:bg-red-50 rounded-md transition-colors mt-4"
                    onClick={() => {
                      setIsMobileMenuOpen(false);
                      handleSignOut();
                    }}
